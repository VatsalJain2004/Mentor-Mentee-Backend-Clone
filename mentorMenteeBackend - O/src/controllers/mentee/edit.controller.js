...
const editPersonalMenteeDetails = async (req, res) => {
  try {
    ...
    // Update mentee details by scholar_no (scholarno)
...
const editDocumentationMenteeDetails = async (req, res) => {
  try {
    ...
    // Update mentee documentation details by scholar_no (scholarno)
    const { data, error } = await supabase
      .from('mentee')
      .update({
...
export { editCoCurricularDetails, editDocumentationMenteeDetails, editIndisciplinaryActionDetails, editExamClearedDetails, editInternshipDetails, editPersonalMenteeDetails, editRecordofMajorAbsenceDetails, editSemesterDetails };