...
const Sidebar = ({ showSidebar }) => {
  ...
  const sidebarLinks = [
    { title: "Dashboard", src: dashboardIcon, redirectTo: "/mentorcoordinator/dashboard" },
    { title: "Profile", src: profileIcon, redirectTo: "/mentorcoordinator/profile"  },
            ...
            <div key={index} className="flex flex-col items-center">
              {item.title === "Profile" ? (
                <div className="relative" ref={dropdownRef}>
                  ...
                  {showProfileDropdown && navigate("/mentorcoordinator/profile")}
                </div>
              ) : (
