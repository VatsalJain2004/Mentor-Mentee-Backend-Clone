...
const MentorList = () => {
  ...
  // Function to handle mentee click
  const handleMenteeClick = () => {
    navigate("/mentorcoordinator/mommenteelist");
  };
    ...
    <div className="h-[801.8px] w-[1240px] gap-[25px] pt-[20px] pb-[40px]">
      <div className="bg-[#F3F3F3] h-auto w-[1238px] mx-[6rem] shadow-[inset_0px_4.21px_4.21px_#00000040] gap-[10.53px] pt-[26.32px] pr-[31.58px] pl-[31.58px] pb-[26.32px]">
        ...
        <div className="flex items-center justify-center gap-2 mb-6">
          ...
          <button className="p-2 text-white bg-red-700 rounded-xl hover:bg-red-800 w-[300px] font-semibold flex items-center justify-center pl-[20px] pr-[20px] gap-[15px] w-[106px] h-[43px] text-3xl">
            <span>Search</span>
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 gap-[32px] pl-8 pt-8 md:grid-cols-2">
          {filteredMentees.length > 0 ? (
            filteredMentees.map((mentee, index) => (
              <div
                key={index}
                className="flex items-center gap-4 pt-[18.67px] pb-[18.67px] pr-[31.12px] pl-[31.12px] text-white bg-red-700 rounded-lg shadow-md w-[554px] h-[136.84px] cursor-pointer hover:bg-red-800"
