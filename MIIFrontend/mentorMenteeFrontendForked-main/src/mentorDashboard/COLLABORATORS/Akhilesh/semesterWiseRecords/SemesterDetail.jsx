    ...
    <div className="w-full px-5 sm:px-10 py-3 font-[arial] font-semibold text-xl">
      ...
      <div className="mx-auto max-w-full p-4 px-5 md:px-10 bg-[#f3f3f3] shadow-[#b9b9b9] shadow-inner">
        ...
        <div className="flex justify-between">
          ...
          <button type="button" className="text-white bg-black font-bold rounded-[5px] text-lg px-10 py-2.5">
            <IoMdPrint className="inline" size={20} />
            <span className="px-2 text-2xl font-bold">Print</span>
          </button>
        </div>
      </div>
    </div>
