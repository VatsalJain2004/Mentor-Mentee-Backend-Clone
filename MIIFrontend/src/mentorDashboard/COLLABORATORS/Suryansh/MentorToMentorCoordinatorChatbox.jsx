...
import MentorToAdminChatbox from "../Gopika/MentorToAdminChatbox";

const MentorToMentorCoordinatorChatbox = () => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center p-4 bg-black/50">
      <div ref={chatRef} className="chat-container w-full bg-white rounded-lg overflow-hidden flex flex-col border-4 border-[#A0A0A0] sm:max-w-[400px] md:max-w-[500px] lg:max-w-[600px]">
        ...
        {/* User Info */}
        <div className="bg-[#a01212] text-white p-3 font-bold">MentorToMentorCoordinatorChatbox</div>
...
export default MentorToMentorCoordinatorChatbox;
