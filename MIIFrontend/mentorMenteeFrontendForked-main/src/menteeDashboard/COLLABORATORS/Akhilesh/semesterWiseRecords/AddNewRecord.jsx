...
const AddNewRecord = ({ title, isOpen, onClose, details = {} }) => {
    ...
    const isFieldDisabled = (field) => existingData[field] !== undefined && existingData[field] !== null;
                    ...
                    <form className="w-full mx-auto grid grid-cols-12 gap-x-2 sm:gap-x-4">
                        ...
                        <div className="mb-5 col-span-6 sm:col-span-4">
                            <Input
                                ...
                                id="mid_sem_i_marks"
                                defaultValue={existingData.mid_sem_i_marks || ""}
                                disabled={isFieldDisabled("mid_sem_i_marks")}
                            />
                        </div>
                        ...
                        <div className="mb-5 col-span-6 sm:col-span-4">
                            <Input
                                ...
                                id="mid_sem_ii_marks"
                                defaultValue={existingData.mid_sem_ii_marks || ""}
                                disabled={isFieldDisabled("mid_sem_ii_marks")}
                            />
                        </div>
                                ...
                                {["I", "II"].map((label, index) => (
                                    <div key={index} className="col-span-1 w-full grid grid-cols-12 bg-white py-2.5">
                                        ...
                                        <input
                                            ...
                                            placeholder="Enter details"
                                            defaultValue={existingData[`quiz_${label}`] || ""}
                                            disabled={isFieldDisabled(`quiz_${label}`)}
                                        />
                                    </div>
                                ))}
                            </div>
                        ...
                        <div className="mb-5 col-span-12">
                            ...
                            <textarea
                                ...
                                placeholder="Enter details"
                                defaultValue={existingData.remark || ""}
